...
\section{Work strategy}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Sofia Cipollone: initialising a random background and music. Added SFX. Created the FXML;
        ...
        \begin{itemize}
            ...
            \item Sofia Cipollone: included the evolution\label{multimap}.
        \end{itemize}
    \end{itemize}
...
\section{Development notes}
    ...
    % Move to collab section.
    %\subsubsection{Use of JavaFX and FXML to create a GUI.}
    %Used in \verb|BattleView| and \verb|battle.fxml|.\\
    %Example at: \url{}
...
\chapter{Final comments}
    ...
    during the battles.\\
    We, Sofia Cipollone and Raffaele Marrazzo, tried to perform a hot fix by using \textit{VisualVM} for profiling.
